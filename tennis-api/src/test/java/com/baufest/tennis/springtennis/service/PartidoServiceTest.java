...
class PartidoServiceTest {
    ...
    Entrenador entrenador = new Entrenador("Rolito Mendez");

    List<Partido> partidosDePrueba = new ArrayList<>();
    List<PartidoDTO> partidosDTODePrueba = new ArrayList<>();

    Jugador jugador1 = new Jugador(1L, "Federer", SCORE_30, entrenador);
    Jugador jugador2 = new Jugador(2L, "Nadal", SCORE_30, entrenador);
